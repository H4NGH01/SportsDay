...
public final class ContestantData implements PlayerHolder {
    ...
    static final ContestantDataType CONTESTANT_DATA_TYPE = new ContestantDataType();
    ...
    public static class ContestantDataType implements PersistentDataType<PersistentDataContainer, ContestantData> {
        private ContestantDataType() {}
